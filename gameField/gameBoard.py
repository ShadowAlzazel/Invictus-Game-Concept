...
class spaceGameBoard:
    ...
    def __init__(self, l, w, hexSize):
        ...
        self.SHIP_HERE_HEX_IMG = SHIP_HERE_HEX_IMG
        self.ENEMY_SHIP_HERE_HEX_IMG = ENEMY_SHIP_HERE_HEX_IMG
        ...
        for hex in operationSpace.starSpaceHexes: 
            ...
            if hex.empty:
                ...
                if hex.entity.command == 'ASCS':
                    gameWindow.blit(self.SHIP_HERE_HEX_IMG, (x, y))
                elif hex.entity.command == 'XNFF':
                    gameWindow.blit(self.ENEMY_SHIP_HERE_HEX_IMG, (x, y))
    ...
    def scaleHexes(self, hexSize):
        ...
        self.SHIP_HERE_HEX_IMG = pygame.transform.scale(SHIP_HERE_HEX_IMG, (hexSize, hexSize))
        self.ENEMY_SHIP_HERE_HEX_IMG = pygame.transform.scale(ENEMY_SHIP_HERE_HEX_IMG, (hexSize, hexSize))
        ...
        self.SHIP_HERE_HEX_IMG.convert()
        self.EMPTY_HEX_IMG.convert()
        self.ENEMY_SHIP_HERE_HEX_IMG.convert()
